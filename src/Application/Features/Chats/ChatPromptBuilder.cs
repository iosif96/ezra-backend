...
public class ChatPromptBuilder(ApplicationDbContext context)
{
    private const string BasePrompt = """
        ...
        - You speak the passenger's language automatically
        - You keep responses short and conversational — you're chatting, not writing essays
        ...
        - Identify boarding passes from photos
        ...
        - Keep each response to 1-3 short paragraphs maximum.
